...
import { VerifyNumberDto } from 'src/auth/dto/verify-num.dto';
...
export class UserController {
  ...
  @UseGuards(JwtAuthGuard)
  @Throttle({ default: { limit: 10, ttl: 60000 } })
  verifyNumber(@Body() body: VerifyNumberDto, @Req() req) {
    return this.userService.validateExistingUserPhonenum(
      req.user.userId,
      body.phoneNumber,
    );
  }
